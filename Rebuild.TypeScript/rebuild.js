...
(function (rb) {
    ...
    var DateTime = (function () {
        ...
        DateTime.formatNumber2 = function (n) {
            return n < 10 ? "0" + n : n.toString();
        };

        DateTime.formatNumber4 = function (n) {
            return n < 10 ? "000" + n : n < 100 ? "00" + n : n < 1000 ? "0" + n : n.toString();
        };

        DateTime.fromDate = function (year, month, day, hour, minute, second, millisecond) {
        ...
        DateTime.prototype.getFirstDayOfWeek = function (firstDayOfWeek) {
            if (typeof firstDayOfWeek === "undefined") { firstDayOfWeek = DayOfWeek.sunday; }
            var v = this.getDate();
        ...
        DateTime.prototype.getLastDayOfWeek = function (lastDayOfWeek) {
            if (typeof lastDayOfWeek === "undefined") { lastDayOfWeek = DayOfWeek.saturday; }
            var v = this.getDate();
        ...
        DateTime.prototype.toString = function (format) {
            return (format || "dd/MM/yyyy").replace("dd", DateTime.formatNumber2(this.getDay())).replace("d", this.getDay().toString()).replace("MM", DateTime.formatNumber2(this.getMonth())).replace("M", this.getMonth().toString()).replace("yyyy", DateTime.formatNumber4(this.getYear())).replace("yy", DateTime.formatNumber4(this.getYear() % 100)).replace("y", this.getYear().toString()).replace("hh", DateTime.formatNumber2(this.getHour())).replace("h", this.getHour().toString()).replace("mm", DateTime.formatNumber2(this.getMinute())).replace("m", this.getMinute().toString()).replace("ss", DateTime.formatNumber2(this.getSecond())).replace("s", this.getSecond().toString());
        };
        ...
        DateTime.dayOfWeeks = [DayOfWeek.sunday, DayOfWeek.monday, DayOfWeek.tuesday, DayOfWeek.wednesday, DayOfWeek.thursday, DayOfWeek.friday, DayOfWeek.saturday];
    ...
    var TimeSpan = (function () {
        ...
        TimeSpan.from = function (days, hours, minutes, seconds, milliseconds) {
        ...
        TimeSpan.timeToMs = function (days, hours, minutes, seconds, milliseconds) {
